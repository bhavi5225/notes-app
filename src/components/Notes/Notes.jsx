...
// import React, { useState, useEffect } from "react";
// import { BiSolidSend, BiArrowBack } from "react-icons/bi"; // import back icon
// import "./Notes.css";

// const Notes = ({ selectedGroup, onBack }) => {
//   const [note, setNote] = useState("");
//   const [notesList, setNotesList] = useState([]);
//   const [groupDetails, setGroupDetails] = useState(null);
...
//       {groupDetails && (
//         <div className="group-header">
//           <BiArrowBack className="back-icon" onClick={onBack} /> {/* Back icon for mobile */}
//           <span
//             className="group-initials"
//             style={{ backgroundColor: groupDetails.color }}
//           >
